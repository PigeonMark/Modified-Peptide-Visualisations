...
from src.util import add_length, split_mods, split
...
if __name__ == "__main__":
    ...
    if use_cache and os.path.exists(cache_file):
        ...
        df = parse_modifications(df, 'modified_sequence', remove_old=False)
        df = add_length(df)
    ...
    # mod_df_dict = split(df, 'mods', single_mod_only=True, keep_same_unmodified_sequence=True)
